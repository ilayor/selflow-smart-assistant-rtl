      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-2/3 md:pr-12 animate-slide-up">
            ...
            <p className="text-xl mb-6">אנחנו עילאי וסהר, לוחמים משוחררים ויזמים צעירים בני 23, בעלי ניסיון משותף בעולם העסקים והטכנולוגיה.</p>
            <p className="text-xl mb-6">הקמנו את מערכת Selflow לאחר שניתחנו את האתגרים היום יומיים שבעלי עסקים בתחום היופי מתמודדים איתם. מניהול לקוחות ותיאום תורים עד לניהול הוצאות והכנסות ומלאי, ומצאנו את הפתרונות היעילים ביותר שיעזרו לכם לחסוך בכמה שיותר זמן בצורה הפשוטה  והנוחה ביותר.</p>
            <p className="text-xl">
